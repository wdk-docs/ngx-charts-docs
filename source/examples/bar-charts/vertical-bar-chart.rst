...
.. _vertical-bar-chart-1:

Vertical Bar Chart
------------------

{% embed
data=“{"url":"https://stackblitz.com/edit/vertical-bar-chart?embed=1&file=app/app.component.ts","type":"link","title":"vertical-bar-chart
- StackBlitz","description":"Vertical Bar Chart demo for
...
+----------+------+---------------+------------------------------------------------+
| yScal    | numb |               | the minimum value of the y axis (ignored if    |
| eMin     | er   |               | chart data contains a lower value)             |
+----------+------+---------------+------------------------------------------------+
| round    | bool | tr            | round edges for the bars                       |
| Edges    | ean  | ue            |                                                |
+----------+------+---------------+------------------------------------------------+
